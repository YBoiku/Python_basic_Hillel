...
class Trader:
    ...
    def write_session_history():
        with open('trader_session_history.json', 'w') as outfile:
            json.dump('trader_session_history.json', outfile)
...
if args["CLI"] == "RATE":
    ...
    config_file.buy_all() and config_file.write_session_history()
elif args["CLI"] == "SELL_ALL":
    config_file.sell_all()
elif args["CLI"] == "NEXT":
    config_file.next()
