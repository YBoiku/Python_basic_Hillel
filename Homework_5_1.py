...
# list_s = []
# for each_symbol in some_list:
#     if some_list.index(each_symbol) == 0 or some_list.index(each_symbol) == len(some_list) - 1:
#         pass
#     elif each_symbol > some_list[(some_list.index(each_symbol)) - 1] + some_list[(some_list.index(each_symbol)) + 1]:
...
# my_string_2 = "asdfff2"
# new_list = []
# for some_sym in my_string_1:
#     factor = my_string_1.find(some_sym) - my_string_1.rfind(some_sym)
#     if factor == 0:
#         if some_sym in my_string_2 and my_string_2.find(some_sym) - my_string_2.rfind(some_sym) == 0:
